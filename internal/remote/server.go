...
// NewServer; Create a new server, automatically selecting a port
...
// Address; the server can be reached it.  Pass this into the `ForwardingReporter`.
...
// readAll; The server will forward all received messages to Ginkgo reporters registered with `RegisterReporters`
